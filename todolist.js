...
class todoapp {
    ...
    async welcomeScreen() {
        const welcome = chalkAnimation.karaoke(boxen(`Welcome to our ⤹★ TODO App ★⤸  
    ...
    async EndScreen() {
        const endscreen = chalkAnimation.karaoke('Thanks for using our TO Do App');
        await this.sleep();
        endscreen.stop();
    }
    async AddTask() {
    ...
    async DeleteTask() {
        ...
        const DeletedItemIndex = this.todoItemlist.indexOf(UserInput.todoItem);
    ...
    async UpdateTask() {
        ...
        const OldTaskIndex = this.todoItemlist.indexOf(UserInput.todoItem);
